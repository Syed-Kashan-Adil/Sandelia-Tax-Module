...
export function Step14TaxSummary(props: { summary: TaxSummary }) {
  ...
  const totalBeforeCredits = s.taxTotalIncludingMunicipal + s.advancePaymentPenalty
      ...
      <div>
        ...
        <div className="space-y-2 rounded-lg border border-border bg-card p-4">
          ...
          <div className="mt-2 rounded-lg border border-border/60 bg-secondary/30 p-3">
            ...
            <div className="mt-2 space-y-1 text-xs text-muted-foreground">
              {[...s.federalGrossTaxUser.brackets, ...s.federalGrossTaxPartner.brackets]
          ...
          />
          <SummaryRow label="Federal tax after allowance" value={eur(federalAfterAllowance)} />
          <SummaryRow
