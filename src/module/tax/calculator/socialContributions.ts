...
/**
 * Company-paid director flow uses the same INASTI formula as personal payment.
 * Only the taxable professional income base changes (salary + benefits, when applicable).
 * No iterative/circular recomputation is applied here.
 */
